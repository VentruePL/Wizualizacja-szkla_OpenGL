...
int main( )
{
    ...
    GLFWwindow *window = glfwCreateWindow( WIDTH, HEIGHT, "Szklo", nullptr, nullptr );
	...
	Shader shader("res/shaders/box_glass.vs", "res/shaders/box_glass.fs");
	...
	unsigned int cubeTexture = loadTexture("res/images/wood.jpg");
